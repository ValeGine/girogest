...
Route::get('/gcal', [GoogleCalendarController::class, 'index']);
Route::post('/gcal/events/store', [GoogleCalendarController::class, 'store']);
Route::post('/gcal/events/edit', [GoogleCalendarController::class, 'edit']);
